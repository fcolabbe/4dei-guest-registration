...
CREATE INDEX IF NOT EXISTS idx_guests_name_company ON guests(name, company);
CREATE INDEX IF NOT EXISTS idx_attendance_guest_time ON attendance(guest_id, check_in_time);
